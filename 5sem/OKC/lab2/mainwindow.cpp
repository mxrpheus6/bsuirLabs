...
void MainWindow::on_pushButtonSend_1_clicked()
{
    ...
    ui->plainTextEditOutput_2->appendPlainText(result);
...
void MainWindow::on_pushButtonSend_2_clicked()
{
    ...
    if (!Packet::transmitPackets(port2, transmittedPackets)) {
        showError("Ошибка отправки данных...");
        return;
    }
    ...
    ui->plainTextEditOutput_1->appendPlainText(result);
