...
#include <memory>
#include "../../kursovoi/authorization.h"
...
QT_MOC_LITERAL(14, 20), // "authorizationSuccess"
QT_MOC_LITERAL(35, 0), // ""
QT_MOC_LITERAL(36, 6), // "access"
...
QT_MOC_LITERAL(74, 30) // "on_pushButton_register_clicked"
    ...
    "Authorization\0authorizationSuccess\0\0"
    "access\0ID\0on_pushButton_login_clicked\0"
...
void Authorization::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->authorizationSuccess((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[2]))); break;
        ...
        {
            using _t = void (Authorization::*)(QString , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Authorization::authorizationSuccess)) {
                *result = 0;
                return;
            }
        }
...
, QtPrivate::TypeAndForceComplete<Authorization, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<QString, std::false_type>, QtPrivate::TypeAndForceComplete<int, std::false_type>
...
// SIGNAL 0
void Authorization::authorizationSuccess(QString _t1, int _t2)
{
