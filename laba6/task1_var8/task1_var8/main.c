...
int main(void)
{
	...
	array_worst(&numbers_worst1, sizeofarray);
	array_worst(&numbers_worst2, sizeofarray);
	...
	array_output(&numbers1, sizeofarray);
	printf("\n\nThe time of Bubble sort is %.3f (ms)\n\n", time);
	printf("Array before changes:\n\n");
	array_output(&numbers2, sizeofarray);
	shell_sort(&numbers2, sizeofarray, &time);
	printf("\n\nArray after Shell Sort:\n\n");
	array_output(&numbers2, sizeofarray);
	printf("\n\nThe time of Shell sort is %.3f (ms)\n\n", time);
	printf("\nWorst array before changes:\n\n");
	array_output(&numbers_worst1, sizeofarray);
	bubble_sort(numbers_worst1, sizeofarray, &time);
	printf("\n\nWorst array after Bubble Sort:\n\n");
	array_output(&numbers_worst1, sizeofarray);
	printf("\n\nThe time of Bubble sort is %.3f (ms)\n\n", time);
	printf("Worst array before changes:\n\n");
	array_output(&numbers_worst2, sizeofarray);
	shell_sort(&numbers_worst2, sizeofarray, &time);
