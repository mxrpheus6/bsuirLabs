...
HD_PWD='D:/BSUIR/bsuirLabs/7sem/APCU/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log parallel.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source parallel.tcl -notrace
